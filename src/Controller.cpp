...
void Controller::refreshController() {
    ...
    data_m.set_righttrigger(mapAxis(SDL_GameControllerGetAxis(controller_m, SDL_CONTROLLER_AXIS_TRIGGERRIGHT)));
    data_m.set_lefttrigger(mapAxis(SDL_GameControllerGetAxis(controller_m, SDL_CONTROLLER_AXIS_TRIGGERLEFT)));
}
